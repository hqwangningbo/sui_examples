...
export declare class JsonRpcProvider extends Provider {
    ...
    devInspectTransactionDeprecated(sender: SuiAddress, tx: UnserializedSignableTransaction | string | Uint8Array, epoch?: number | null): Promise<DevInspectResults>;
