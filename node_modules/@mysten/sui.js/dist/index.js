...
var getMasterKeyFromSeed = (seed) => {
  ...
  const I = h.update((0, import_bcs5.fromHEX)(seed)).digest();
...
var Ed25519Keypair = class {
  ...
  export() {
    return {
      schema: "ED25519",
      privateKey: (0, import_bcs6.toB64)(this.keypair.secretKey)
    };
  }
};
...
function isValidTransactionDigest(value) {
  try {
    const buffer = import_bs58.default.decode(value);
...
function generateTransactionDigest(data, bcs2) {
  ...
  return import_bs58.default.encode(hash);
}
...
function registerObjectDigest(bcs2) {
  bcs2.registerType(
    "ObjectDigest",
    (writer, str) => {
      let bytes = Array.from((0, import_bcs10.decodeStr)(str, "base64"));
      return writer.writeVec(bytes, (writer2, el) => writer2.write8(el));
    },
    (reader) => {
      let bytes = reader.readVec((reader2) => reader2.read8());
      return (0, import_bcs10.encodeStr)(new Uint8Array(bytes), "base64");
    }
  );
}
...
var bcs = new import_bcs10.BCS((0, import_bcs10.getSuiMoveConfig)());
registerUTF8String(bcs);
registerObjectDigest(bcs);
registerTypes(bcs, BCS_SPEC);
var bcs_0_23 = new import_bcs10.BCS((0, import_bcs10.getSuiMoveConfig)());
registerUTF8String(bcs_0_23);
registerObjectDigest(bcs_0_23);
registerTypes(bcs_0_23, BCS_0_23_SPEC);
var bcs_0_24 = new import_bcs10.BCS((0, import_bcs10.getSuiMoveConfig)());
...
var ValidatorMetaData = (0, import_superstruct8.object)({
  ...
  name: (0, import_superstruct8.array)((0, import_superstruct8.number)()),
  description: (0, import_superstruct8.nullable)((0, import_superstruct8.array)((0, import_superstruct8.any)())),
  image_url: (0, import_superstruct8.nullable)((0, import_superstruct8.array)((0, import_superstruct8.any)())),
  project_url: (0, import_superstruct8.nullable)((0, import_superstruct8.array)((0, import_superstruct8.any)())),
...
var JsonRpcProvider = class extends Provider {
  ...
  async executeTransaction(txnBytes, signature, requestType = "WaitForEffectsCert") {
    try {
      return await this.client.requestWithType(
        "sui_executeTransactionSerializedSig",
        [
          typeof txnBytes === "string" ? txnBytes : (0, import_bcs11.toB64)(txnBytes),
          signature,
          requestType
        ],
  ...
  async getReferenceGasPrice() {
    ...
    if (version && (0, import_femver2.lt)(versionToString(version), "0.22.0")) {
      return 1;
    }
    try {
      return await this.client.requestWithType(
  ...
  async devInspectTransaction(sender, tx, gasPrice = null, epoch = null) {
    try {
      ...
      if (typeof tx === "string") {
        ...
        devInspectTxBytes = (0, import_bcs11.toB64)(tx);
      } else {
        devInspectTxBytes = (0, import_bcs11.toB64)(
...
var RpcTxnDataSerializer = class {
  ...
  async serializeToBytes(signerAddress, unserializedTxn, mode = "Commit") {
    ...
    try {
      ...
      return (0, import_bcs12.fromB64)(resp.txBytes);
    } catch (e) {
      throw new Error(
...
var import_femver3 = require("@suchipi/femver");
...
var VoidProvider = class extends Provider {
  ...
  async executeTransaction(_txnBytes, _signature, _requestType) {
...
var SignerWithProvider = class {
  ...
  async signTransaction(transaction) {
    ...
    return {
      transactionBytes: (0, import_bcs13.toB64)(transactionBytes),
      signature
    };
  }
  ...
  async dryRunTransaction(tx) {
    ...
    let dryRunTxBytes;
    if (typeof tx === "string") {
      dryRunTxBytes = (0, import_bcs13.fromB64)(tx);
    } else if (tx instanceof Uint8Array) {
      dryRunTxBytes = tx;
    } else {
      switch (tx.kind) {
...
var RawSigner = class extends SignerWithProvider {
  ...
  async signData(data) {
    const version = await this.provider.getRpcApiVersion();
    let useRecoverable = version && (0, import_femver3.gt)(versionToString(version), "0.24.0") ? false : true;
...
async function verifyMessage(message, serializedSignature) {
  const signature = fromSerializedSignature(serializedSignature);
  const messageBytes = messageWithIntent(
    3 /* PersonalMessage */,
    typeof message === "string" ? (0, import_bcs14.fromB64)(message) : message
  );
  switch (signature.signatureScheme) {
    ...
    case "Secp256k1":
      return secp2.verify(
        ...
        await secp2.utils.sha256(messageBytes),
        signature.pubKey.toBytes()
      );
    default:
      throw new Error(
